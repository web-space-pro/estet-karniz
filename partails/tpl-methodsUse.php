    ...
    <div class="container">
        <div class="row">
            <div class="mb-16 lg:mb-24 ">
                <h2 class="text-2xl md:text-4xl uppercase text-center font-bold"><?=$title;?></h2>
            </div>
        </div>
    </div>
    <div class="pt-15">
                ...
                <?php foreach( $items as $item ): ?>
                    <div class="swiper-slide bg-white-200 md:rounded-[3.5rem] overflow-hidden">
                        <figure class="relative">
                            <img class="w-full h-full object-cover object-center" src="<?= $item['foto']['url'];?>" alt="<?= the_title();?>">
                            <?php if($settings_show): ?>
                                <div class="absolute bottom-0 left-0 bg-blue-100 text-white-900 uppercase font-medium px-9 py-2 mb-20 rounded-br-[50px] rounded-tr-[50px]">
                                    <?= $item['metka']?>
                                </div>
                            <?php endif;?>
                        </figure>
